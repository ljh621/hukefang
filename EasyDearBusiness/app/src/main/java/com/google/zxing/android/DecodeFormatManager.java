...
final class DecodeFormatManager {
  ...
  static final Set<BarcodeFormat> PRODUCT_FORMATS;//商品格式
  static final Set<BarcodeFormat> INDUSTRIAL_FORMATS;//工业格式
  private static final Set<BarcodeFormat> ONE_D_FORMATS;//一维格式
