...
import com.jingan.easydearbusiness.function.accountFunction.data.source.LoginDataSoure;
...
public class AccountPresenter implements LoginDataSoure.LoginCallBack, AccountContract.Presenter {

    private AccountContract.LoginView loginView;
    private LoginDataSoure remoteRepo;

    public AccountPresenter(LoginRemoteRepo remoteRepo, AccountContract.LoginView loginView) {
